function total_dos = generate_ADOS_SBM(dataset_name, Nbins, seed)
    ...
    %maybe need to have normalized adjacency matrix here
    %or unweighted adjacency matrix
    ...
    if is_lbl
        %load(strcat("processed/",dataset_name,"/",dataset_name,"_all_OH_labels.mat"),all_OH_labels);
